...
public class ClusterHAHealthResponse extends ActionResponse implements StatusToXContentObject {
    ...
    private static final ConstructingObjectParser<ClusterHAHealthResponse, Void> PARSER = new ConstructingObjectParser<>(
            ...
            parsedObjects -> {
                ...
                // ClusterHAHealthResponse fields
    ...
    public ClusterHAHealthResponse(String clusterName, String[] concreteIndices, ClusterState clusterState) {
    ...
    public static ClusterHAHealthResponse readResponseFrom(StreamInput in) throws IOException {
    ...
    public static ClusterHAHealthResponse fromXContent(XContentParser parser) {
    ...
    public boolean equals(Object o) {
        ...
        ClusterHAHealthResponse that = (ClusterHAHealthResponse) o;
